      ...
      body: Center(
        child: widget.button(onPressed: () async {
          try {
            ...
            // The user closed the popup, which is a normal flow.
            // We can print a message for debugging, but we don't need to show an error to the user.
            debugPrint('Sign-in failed or cancelled: $e');
          }
        },),
      ),
    );
